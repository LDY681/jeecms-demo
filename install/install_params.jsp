...
<form action="install_setup.svl" method="post"
  ...
  <table width="980" border="0" align="center" cellpadding="0" cellspacing="0" class="rg-tbg">
    <tr>
      <td height="76" align="center"><h2>2、系统参数设置（环境要求：jdk1.7或以上、tomcat7或以上、mysql5.0或以上）</h2>
...
<input type="hidden" name="dbFileName"
	value="/install/db/jeecms-db-v9.sql" /> <input type="hidden"
	name="initFileName" value="/install/db/jeecms-init-v9.sql" />
</form>
</body>
</html>
